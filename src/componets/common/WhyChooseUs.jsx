...
const WhyChooseUs = () => {
  ...
  return (
    <section className="py-[5rem] bg-gradient-to-r from-secondary/20 to-primary/20">
      <div className="wrapper text-center flex flex-col gap-7">
        <div data-aos="fade-up" className="gradient-rounded-text-box mx-auto">
          Why Choose Us
        </div>
        <div className="flex flex-col gap-5">
          <h2 data-aos="fade-up" className="heading-2">
            The Innovation Powering Our IT Solutions
          </h2>
          <p data-aos="fade-up" className="desc max-w-[40rem] mx-auto">
            Our process starts with a thorough needs analysis to identify your
            unique requirements, challenges, and objectives.
          </p>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 items-center gap-5 mt-9">
            <div className="flex flex-col gap-5 h-full">
              <div
                data-aos="fade-right"
                className="p-5 border border-primary bg-gradient-to-br from-secondary/40 to-primary/60 rounded-xl w-full h-full"
              >
                ...
                <p className="desc text-start mt-3">
                  A trusted IT company should demonstrate exceptional technical
                  proficiency.
                </p>
              </div>
              <div
              ...
              >
                ...
                <p className="desc text-start mt-3">
                  A reliable IT company must showcase advanced technical
                  expertise.
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col gap-5 h-full">
              ...
              >
                ...
                <p className="desc text-start mt-3">
                  A respected IT company must have a strong foundation of
                  technical expertise.
                </p>
              </div>
              <div
              ...
              >
                ...
                <p className="desc text-start mt-3">
                  An IT company should place a strong emphasis on cybersecurity
        ...
        <div className="pt-[3rem]">
          <div
            ref={ref}
            data-aos="fade-up"
            className="w-full grid sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-10 lg:gap-5 rounded-3xl bg-gradient-to-r from-secondary to-primary p-[2rem] text-white"
          >
