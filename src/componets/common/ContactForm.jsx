...
const ContactForm = () => {
  ...
  const handleFormSubmit = async (values) => {
    ...
    var payload = {
      ...
      subject: "Contact Form Submission - Solvionis",
      body: emailBody,
      name:"Solvionis",
    };
  ...
  return (
    <div className="wrapper py-[5rem] grid lg:grid-cols-[45%_auto] gap-7">
      <div
        data-aos="fade-right"
        className="bg-gradient-to-r flex flex-col gap-2 from-secondary/20 to-primary/20 p-5 rounded-xl"
      >
        <div className="gradient-rounded-text-box">Book an Appointment</div>
        <h2 className="heading-2 mt-5">Get in Touch</h2>
        <p className="desc">
          Are you ready to take your business to the next level with advanced AI
          and innovative digital solutions?
          <br />
          Let’s collaborate to turn your vision into reality and propel your
        ...
        >
          <div className="w-[2.5rem] h-[2.5rem] rounded-full bg-primary text-white flex justify-center items-center">
        ...
        <div className="flex items-start gap-3 w-fit mt-5">
          <div className="min-w-[2.5rem] w-[2.5rem] h-[2.5rem] rounded-full bg-primary text-white flex justify-center items-center">
      ...
      >
        <div className="p-[1px] h-full border border-primary rounded-lg">
          <div className="rounded-lg h-full p-3">
        ...
        <div className="flex gap-5 items-center mb-1">
          ...
          <div className="flex items-center gap-3">
            ...
            <Link target="_blank" to={companyDetails.instagram} className="group w-[2.5rem] h-[2.5rem] rounded-full border-primary border flex justify-center items-center">
