...
const Portfolio = ({ page }) => {
  ...
  return (
    <div id="portfolio" className="bg-primary/10 py-[5rem]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {portfolio.map((item) => (
              <div
                data-aos="fade-up"
                key={item.id}
                className="flex flex-col gap-3 rounded-md overflow-hidden relative aspect-square group w-full"
              >
                <img
                  src={item.img}
                  alt=""
                ...
                />
                <div className="absolute bottom-0 left-0 w-full p-2 bg-primary/90 text-white flex flex-col gap-2">
