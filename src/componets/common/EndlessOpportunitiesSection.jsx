...
const EndlessOpportunitiesSection = () => {
  ...
  return (
    <>
      <section className="wrapper flex flex-col items-center justify-center py-14 text-center md:py-20">
      ...
      <section className="pt-7 pb-[5rem] bg-background overflow-hidden">
