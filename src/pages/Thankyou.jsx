...
const Thankyou = () => {
  return (
    <div className="min-h-screen flex flex-col justify-between bg-primary/20">
      ...
      <div className="wrapper h-full flex flex-col items-center py-[8rem] gap-3 text-center">
          ...
          <div className="pt-4 mt-7 border-t border-primary w-full">
            <div className="flex justify-center gap-5 w-full">
              <div className="flex gap-5 items-center mt-5">
                <Link>
                  <BsFacebook className="text-xl hover:text-primary transition-all duration-300" />
                </Link>
                <Link>
                  <BsTwitter className="text-xl hover:text-primary transition-all duration-300" />
                </Link>
                <Link>
                  <BsLinkedin className="text-xl hover:text-primary transition-all duration-300" />
                </Link>
                <Link>
                  <BsYoutube className="text-xl hover:text-primary transition-all duration-300" />
                </Link>
              </div>
            </div>
          </div>
